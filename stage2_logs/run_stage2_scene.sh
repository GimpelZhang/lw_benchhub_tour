#!/bin/bash
# Stage 2 v6 single-scene runner. KEY CHANGE vs v3: video_length=1100 to
# record full 22s episodes at 50 Hz (was 200 → only 4 s, looked empty).
set +u
CONFIG_REL="$1"
OUTPUT_DIR="$2"
