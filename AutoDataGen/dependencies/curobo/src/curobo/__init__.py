...
def _get_version():
    ...
    # v6 patch: honor PRETEND_VERSION env var BEFORE any setuptools_scm work,
    # because isaacsim 5.1's prebundled setuptools_scm in lerobot-arena env
    # ignores the env var and crashes with LookupError instead.
    pretend = os.environ.get("SETUPTOOLS_SCM_PRETEND_VERSION_FOR_NVIDIA_CUROBO")
    if pretend:
        return pretend
